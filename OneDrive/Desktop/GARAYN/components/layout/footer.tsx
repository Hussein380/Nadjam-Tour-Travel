              ...
              {[
                ...
                >
                  <Link
                    ...
                    className="w-10 h-10 rounded-full bg-card/50 backdrop-blur-sm border border-primary/10 flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary/30 transition-all duration-300"
                  >
